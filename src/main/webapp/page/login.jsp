                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in" id="signup">
                                    ...
                                    <form id="signup" action="signup" method="post">
                                        ...
                                        <div class="form-group">
                                            <label><span class="req"></span> </label>
                                            <input placeholder="Your Phone" type="tel" name="phonenum"
                                        ...
                                        <div class="form-group">
                                            <label><span class="req"></span> </label>
                                            <input placeholder="Verification" type="text" name="Verification"
                                                id="Verification" class="form-control" id="usercode" required
                                                data-validation-required-message="Please enter Verification in your email"
                                                autocomplete="off">
                                            <p class="help-block text-danger"></p>
                                            <input id="verification_button" onclick="sendEmail()" value="Get Verification Code" type="button">
                                        </div>
                                        <p id="checkCode"></p>
                                ...
                                <div class="tab-pane fade active in" id="login">
                                    ...
                                    <form id="login" method="post" action="login">
                                        <div class="form-group">
                                            <label><span class="req"></span> </label>
                                            <input placeholder="Your Email" type="email" name="email" value="${email}"
                                                class="form-control" id="email" required
                                                data-validation-required-message="Please enter your email address."
                                                autocomplete="off">
                                            <p class="help-block text-danger"></p>

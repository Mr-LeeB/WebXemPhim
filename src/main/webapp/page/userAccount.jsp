                        ...
                        <div class="collapse" id="search-nav">
                            <form class="navbar-left navbar-form nav-search mr-md-3">
                                <div class="input-group">
                                    ...
                                    <input id="input_Search" type="text" placeholder="Search ..." class="form-control" oninput="Search()">                                </div>
                            </form>
                        </div>
                    ...
                    <div class="page-inner" style="padding-left: 0; padding-right: 0;">
                        ...
                        <div class="card">
                            <div class="card-header" style="position: relative;">
                                <div class="card-title">User Account Table</div>
                            ...
                            <div class="card-body" style="padding-top: 0px;">
                                ...
                                <table id="main_Table" class="table mt-0">
                                    ...
                                    <tbody class="nowPlaying_tbody">
                                        <c:forEach var="p" items="${ListUserAccount}">
                                                ...
                                                <div class="Pass_Phone formChinhSua mt-5">
                                                    ...
                                                    <span class="input-group input_Phone ml-3">
                                                        <input id="input_Phone" required="" type="text"
                                                            name="VietnamName" autocomplete="off" class="input"
                                                            style="width: 100%; font-size: 15px;">
                                                        <label class="user-label" style="font-size: 15px;">Phone
                                                            number</label>
                                                    </span>
                                                </div>
                                            </div>

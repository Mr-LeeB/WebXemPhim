                ...
                <div class="colCenter" style=" width: 82%; height: 800px">
                    <div class="colCenter_menu d-flex">
                        <div class="div1 d-flex" style="width: 100%;">
                            <span style="width: 100%;font-size: 35px;font-weight: 700" class="Movie active">ACCOUNT
                                SETTINGS</span>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="card shadow-sm">
                                        <div id="image_user" class="card-header bg-transparent text-center">
                                            <div>
                                                <img class="profile_img" style="width: 150px; height: 150px;"
                                                    src="image/index/defaultAvatar.jpg" alt="">
                                                <h3>${user.userName}</h3>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <p class="mb-0"><strong class="pr-1">Email: </strong>${user.email}</p>
                                            <p class="mb-0"><strong class="pr-1">User Name: </strong>${user.userName}
                                            </p>
                                ...
                                <div class="col-lg-8">
                                            ...
                                            <form action="update" method="post">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="2%">:</td>
                                                        <td>
                                                            <input type="tel" name="phonenum" value="${user.phoneNum}"
                                                                class="form-control" id="phonenum" required
                                                ...
                                                <c:if test="${sessionScope.user != null}">
                                                    <div class="mrgn-30-top">
                                                        <button id="updateButton" type="submit" class="btn btn-larger" />
                                                        Update
                                                        </button>
                                                    </div>
                                                </c:if>
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-header bg-transparent border-0">
                                            <div id="OtherInfo">
                                                <h3 class="mr-3">
                                                    <i class="far fa-clone pr-1 mr-4"></i>
                                                    Other Information
                                                </h3>
                                            </div>
                                        </div>

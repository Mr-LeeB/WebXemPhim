<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <body>
            ...
            <div class="total p-0">
                ...
                <div class="colCenter">
                    <div class="banner">
                        ...
                        <div class="content">
                            <div class="icon">
                                <c:if test="${sessionScope.user == null}"><a href="login">
                                        <button type="submit">
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 1024 1024"
                                                class="text-white group-hover:text-primary transition duration-300 false"
                                ...
                                <c:if test="${sessionScope.user != null}">
                                    <button onclick="AddToBookmarked(${movieWatchPage.movieId})" type="submit">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                            viewBox="0 0 1024 1024"
                                            class="text-white group-hover:text-primary transition duration-300 false"
                                            height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button>
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
                                        class="text-white group-hover:text-primary transition duration-300" height="20"
                    ...
                    <div class="movie_describe">
                                ...
                                <div class="rating_content">
                                    ...
                                    <svg class="CircularProgressbar " viewBox="0 0 100 100"
                                        ...
                                        <path class="CircularProgressbar-path" d="
                                          ...
                                          a 46,46 0 1 1 0,-92
                                          " stroke-width="8" fill-opacity="0"
                                            style="stroke: rgba(81, 121, 255, 0.85); stroke-dasharray: 289.027px, 289.027px; stroke-dashoffset: 42.5736px;">
                                        </path>
                                    </svg>
                                    <span class="rating_number">8.5</span>
                                </div>
                                <div class="runtime">
                                    <span>RUNTIME</span>
                                    <span>106
                        ...
                        <div class="story">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                        data-bs-target="#overall" type="button" role="tab" aria-controls="home"
                                        aria-selected="true">Overall</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#cast" type="button" role="tab" aria-controls="profile"
                                        aria-selected="false">Cast</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overall" role="tabpanel"
                                    ...
                                    <div class="summary">
                                        It was almost like seeing something out of a dream, nothing more or less than a
                                        breathtaking view.
                                    </div>
                                ...
                                <div class="tab-pane fade" id="cast" role="tabpanel" aria-labelledby="profile-tab">
                                    <div id="cast_content">
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-1.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Ryunosuke Kamiki
                                                </p>
                                        ...
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-2.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Mone Kamishiraishi
                                                </p>
                                                <p class="cast_alias">
                                                    as Mitsuha Miyamizu (voice)
                                                </p>
                                            </div>
                                        </div>
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-3.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Ryo Narita
                                                </p>
                                        ...
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-4.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Aoi Yuki
                                                </p>
                                                <p class="cast_alias">
                                                    as Sayaka Natori (voice)
                                                </p>
                                            </div>
                                        </div>
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-5.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Nobunaga Shimazaki
                                                </p>
                                                <p class="cast_alias">
                                                    as Tsukasa Fujii (voice)
                                                </p>
                                            </div>
                                        </div>
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-6.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Kaito Ishikawa
                                                </p>
                                                <p class="cast_alias">
                                                    as Shinta Takagi (voice)
                                                </p>
                                            </div>
                                        </div>
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-7.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Kanon Tani
                                                </p>
                                                <p class="cast_alias">
                                                    as Yotsuha Miyamizu (voice)
                                                </p>
                                            </div>
                                        </div>
                                        <div class="cast-item">
                                            <img src="./image/watch/cast/cast-8.jpg" alt="#">
                                            <div class="name">
                                                <p class="cast_name">
                                                    Masaki Terasoma
                                                </p>
                        ...
                        <div class="media">
                            ...
                            <div class="trailer">
                                <iframe width="252" height="142" src="${movieWatchPage.trailerLink}"
        ...
        <script>
            function AddToBookmarked(movieID) {
                $.ajax({
                    url: "/WebXemPhim/addbookmarked",

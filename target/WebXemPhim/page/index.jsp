            ...
            <div class="total_child d-flex">
                    ...
                    <div class="colLeft_child">
                        ...
                        <div class="colLeft_personal_item">
                            ...
                            <div class="colLeft_general_item">
                                <a class="item active" <c:if test="${sessionScope.admin == false}">href="profile"</c:if>
                               <c:if test="${sessionScope.admin == true}">href="admin"</c:if>
                               <c:if test="${sessionScope.admin == null}">href="login"</c:if>>
                                   <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                        height="25" width="25" xmlns="http://www.w3.org/2000/svg">
                                   <path
                ...
                <div class="colCenter">
                    ...
                    <c:if test="${CheckSearch == true}">
                        <div class="owl-carousel owl-theme popular__carousel position-relative">
                            <c:forEach items="${ListMovieSearch}" var="list">
                                <div class="item item__tag">
                                    <a href="watch?moviechoosed=${list.movieId}">
                                        <div class="item__content">
                                            <img class="img-fluid" src="${list.imagemin}" alt="#">
                                            <span class="vote">
                                                <span class="star">${list.movieStar}</span>
                                                <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                                     viewBox="0 0 1024 1024" height="15" width="15"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                <path
                                            ...
                                            <div class="name">${list.nameEnglish}</div>
                                        </div>
                                    </a>
                                </div>
                            </c:forEach>
                ...
                <div class="colRight">
                    <div class="search_bar">
                        <form class="relative" method="get" action="search">
                            ...
                            <input class="input_search" name="input_search" style="background-color: #333335;" type="text"

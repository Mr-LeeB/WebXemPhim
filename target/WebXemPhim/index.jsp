                ...
                <div class="colCenter">
                    <div class="colCenter_menu d-flex">
                        ...
                        <div class="div3 d-flex" style="width: 18%;">
                            <c:if test="${sessionScope.user != null}">
                                <span style="width: 70%;" class="Anonymous">${user.email}</span>
                            </c:if>
                            <c:if test="${sessionScope.user == null}">
                    ...
                    <div class="popular mt-5">
                        ...
                        <div class="owl-carousel owl-theme popular__carousel position-relative">
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular1.jpg" alt="#">
                                        <span class="vote">
                            ...
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular2.jpg" alt="#">
                                        <span class="vote">
                                            <span class="star">5.1</span>
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="15"
                                                 width="15" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M908.1 353.1l-253.9-36.9L540.7 86.1c-3.1-6.3-8.2-11.4-14.5-14.5-15.8-7.8-35-1.3-42.9 14.5L369.8 316.2l-253.9 36.9c-7 1-13.4 4.3-18.3 9.3a32.05 32.05 0 0 0 .6 45.3l183.7 179.1-43.4 252.9a31.95 31.95 0 0 0 46.4 33.7L512 754l227.1 119.4c6.2 3.3 13.4 4.4 20.3 3.2 17.4-3 29.1-19.5 26.1-36.9l-43.4-252.9 183.7-179.1c5-4.9 8.3-11.3 9.3-18.3 2.7-17.5-9.5-33.7-27-36.3z">
                                        ...
                                        <div class="name">After Ever Happy</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular3.jpg" alt="#">
                                        <span class="vote">
                                        ...
                                        <div class="name">Bullet Proof</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular4.jpg" alt="#">
                                        <span class="vote">
                                            <span class="star">6.9</span>
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="15"
                                                 width="15" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M908.1 353.1l-253.9-36.9L540.7 86.1c-3.1-6.3-8.2-11.4-14.5-14.5-15.8-7.8-35-1.3-42.9 14.5L369.8 316.2l-253.9 36.9c-7 1-13.4 4.3-18.3 9.3a32.05 32.05 0 0 0 .6 45.3l183.7 179.1-43.4 252.9a31.95 31.95 0 0 0 46.4 33.7L512 754l227.1 119.4c6.2 3.3 13.4 4.4 20.3 3.2 17.4-3 29.1-19.5 26.1-36.9l-43.4-252.9 183.7-179.1c5-4.9 8.3-11.3 9.3-18.3 2.7-17.5-9.5-33.7-27-36.3z">
                                        ...
                                        <div class="name">Thor: Love and Thun...</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular5.jpg" alt="#">
                                        <span class="vote">
                                            <span class="star">6.2</span>
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="15"
                                                 width="15" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M908.1 353.1l-253.9-36.9L540.7 86.1c-3.1-6.3-8.2-11.4-14.5-14.5-15.8-7.8-35-1.3-42.9 14.5L369.8 316.2l-253.9 36.9c-7 1-13.4 4.3-18.3 9.3a32.05 32.05 0 0 0 .6 45.3l183.7 179.1-43.4 252.9a31.95 31.95 0 0 0 46.4 33.7L512 754l227.1 119.4c6.2 3.3 13.4 4.4 20.3 3.2 17.4-3 29.1-19.5 26.1-36.9l-43.4-252.9 183.7-179.1c5-4.9 8.3-11.3 9.3-18.3 2.7-17.5-9.5-33.7-27-36.3z">
                                        ...
                                        <div class="name">DC League of Super-...</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular6.jpg" alt="#">
                                        <span class="vote">
                                        ...
                                        <div class="name">Jurassic World Domi...</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular7.jpg" alt="#">
                                        <span class="vote">
                            ...
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular8.jpg" alt="#">
                                        <span class="vote">
                            ...
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular9.jpg" alt="#">
                                        <span class="vote">
                                        ...
                                        <div class="name">Fullmetal Alchemist:...</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular10.jpg" alt="#">
                                        <span class="vote">
                                        ...
                                        <div class="name">Secret Headquarters</div>
                                    </div>
                                </a>
                            </div>
                            <div class="item item__tag">
                                <a href="#">
                                    <div class="item__content">
                                        <img class="img-fluid" src="./image/index/popular11.jpg" alt="#">
                                        <span class="vote">
                                            <span class="star">5.2</span>
                                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="15"
                                                 width="15" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M908.1 353.1l-253.9-36.9L540.7 86.1c-3.1-6.3-8.2-11.4-14.5-14.5-15.8-7.8-35-1.3-42.9 14.5L369.8 316.2l-253.9 36.9c-7 1-13.4 4.3-18.3 9.3a32.05 32.05 0 0 0 .6 45.3l183.7 179.1-43.4 252.9a31.95 31.95 0 0 0 46.4 33.7L512 754l227.1 119.4c6.2 3.3 13.4 4.4 20.3 3.2 17.4-3 29.1-19.5 26.1-36.9l-43.4-252.9 183.7-179.1c5-4.9 8.3-11.3 9.3-18.3 2.7-17.5-9.5-33.7-27-36.3z">
                                        ...
                                        <div class="name">Bullet Train</div>
                                    </div>
                                </a>
                            </div>
                        </div>
